...
public class Selection : MonoBehaviour
{
    ...
    [SerializeField]
    private InputActionProperty launchPrefab;
    ...
    void Start()
    {
        ...
        launchPrefab.action.performed += OnLaunchPrefab;
    ...
    private void OnLaunchPrefab(InputAction.CallbackContext context)
    {
        ...
        if (rb != null)
        {
            // 45 degree angle direction in world space (forward + up)
            Vector3 direction = (rightHand.transform.forward + rightHand.transform.up).normalized;
