...
public class GrabEffectHold : GrabEffect
{
    ...
    /// <summary>
    /// Helper function to hide the hand 
    /// </summary>
    /// <param name="hide">turn on and off, if allowed</param>
    protected void HideHand(bool hide) //XXXXXXXXX
    {
    ...
    {
    //sanity check, if this controller already has a object stop
    ...
    public override void Reset(Grab controller)
    {
        ...
        //if not the final release, reparent and stop
